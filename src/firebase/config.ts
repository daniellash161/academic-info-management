...
if (missing.length) {
  ...
  console.error("[FIREBASE CONFIG] Loaded values (masked):", {
    ...
    VITE_FIREBASE_AUTH_DOMAIN: env("VITE_FIREBASE_AUTH_DOMAIN") ? "OK" : "",
    VITE_FIREBASE_PROJECT_ID: env("VITE_FIREBASE_PROJECT_ID") ? "OK" : "",
    VITE_FIREBASE_STORAGE_BUCKET: env("VITE_FIREBASE_STORAGE_BUCKET") ? "OK" : "",
